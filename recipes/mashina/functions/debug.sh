function mashina_debug {
  ...
  echo "MASHINA_IS_DEBIAN: $(mashina__is_debian;echo $?)"
  echo "MASHINA_IS_MACOS: $(mashina__is_macos;echo $?)"
  echo "MASHINA_IS_BASH: $(mashina__is_bash;echo $?)"
  echo "MASHINA_IS_ZSH: $(mashina__is_zsh;echo $?)"
  echo "TERM: $TERM"
  echo "PATH: $PATH"
